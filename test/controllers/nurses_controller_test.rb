...
class NursesControllerTest < ActionController::TestCase
  ...
  test "should create nurse" do
    assert_difference('Nurse.count') do
      post :create, nurse: { department_id: @nurse.department_id, doctor_id: @nurse.doctor_id, email: @nurse.email, name: @nurse.name, phone: @nurse.phone }
    end
  ...
  test "should update nurse" do
    patch :update, id: @nurse, nurse: { department_id: @nurse.department_id, doctor_id: @nurse.doctor_id, email: @nurse.email, name: @nurse.name, phone: @nurse.phone }
    assert_redirected_to nurse_path(assigns(:nurse))
  end
